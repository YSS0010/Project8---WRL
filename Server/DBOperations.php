...
public function __construct() {
 ...
 public function insertData($first_name,$surname,$email,$password){
   ...
   $sql = 'INSERT INTO users SET uno =:uno,first_name =:first_name,surname =:surname,
    email =:email,encrypted_password =:encrypted_password,salt =:salt,created_at = NOW()';

   $query = $this ->conn ->prepare($sql);
   $query->execute(array('uno' => $uno, ':first_name' => $first_name, ':surname' => $surname, ':email' => $email,
